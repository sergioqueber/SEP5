...
<div class="row">
<div class="col-md-12">
                <h3 class="mb-3">Choose the store to display messages from</h3>
                <hr>
            </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <?php foreach($results1 as $row1){
                                ?>
                            <h5 class="card-title"><a href="managermessagestore.php?id=<?php echo htmlspecialchars($row["store_id"]); ?>"><?php echo htmlspecialchars($row1["store_name"]); ?></a></h5>
                            <!-- Product price -->
